...
export default class MenuFornecedor extends Component {
  state = {
  }
    ...
    return (
        <View style={{width: "85%", height:"100%", alignSelf: "center"}}>
          <View style={{height:"40%", justifyContent: "center"}}>
            ...
            <Text style={{fontWeight: "600", fontSize:30,alignSelf:"center"}}>Menu Fornecedor</Text>            
            </View>
            <Button 
              ...
              color="green"
              onPress={() => {
				this.props.navigation.navigate('Meus Produtos')
              }} 
            />            
            ...
            <Button 
              ...
              color="green"
              onPress={() => {
				this.props.navigation.navigate('Cadastrar Produtos')  
              }} 
            />
            <Text style={{fontWeight: "300", fontSize:10,alignSelf:"center"}}> </Text>
            <Button 
